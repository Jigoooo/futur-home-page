...
export const caseStories: CaseStory[] = [
  {
    ...
    artifact: {
      ...
      columns: ['사용자', '결제', '운영'],
      rows: [
        { title: '신청 정보', meta: '작성 · 검증' },
        { title: '결제 상태', meta: '요청 · 확인' },
        { title: '처리 이력', meta: '배정 · 완료' },
      ],
    },
  },
  {
    ...
    artifact: {
      ...
      columns: ['촬영', '스캔', '확인'],
      rows: [
        { title: '현장 캡처', meta: '사진 · 위치' },
        { title: '식별 정보', meta: '바코드 · 항목' },
        { title: '관리 확인', meta: '누락 · 처리' },
      ],
    },
  },
  {
