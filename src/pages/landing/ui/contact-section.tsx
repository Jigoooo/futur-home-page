...
import { briefStages, budgetOptions, timelineOptions } from '../config';
    ...
    <>
      ...
      >
        <div className={sharedStyles.container}>
          <div className={styles.contactSurface} data-contact-surface data-cursor-contrast='light'>
            <div className={styles.ctaWrap}>
              <div>
                <p className={styles.contactLabel}>프로젝트 문의</p>
                <EditorialTextReveal
                  as='h2'
                  className={styles.ctaTitle}
                  lines={['만들거나 개선하려는', '제품을 알려주세요.']}
                  split='lines'
                  trigger='in-view'
                  accessibleLabel='만들거나 개선하려는 제품을 알려주세요.'
                />
                <p>현재 상황과 필요한 범위를 적어주시면 확인 후 연락드리겠습니다.</p>
              </div>
              <div className={styles.ctaActions}>
                <Button href={mailHref} data-cursor-contrast='dark'>
            ...
            <div className={cx(styles.contactLayout, sharedStyles.gridLayout)}>
              <div
                className={cx(styles.contactCard, sharedStyles.stickyLead)}
                data-contact-motion-group
              >
                <h3>문의에 포함하면 좋은 내용</h3>
                <p>아직 정해지지 않은 항목은 비워두거나 문의 내용에 그대로 적어주세요.</p>
                <ol className={styles.contactRail}>
                  {['현재 해결하려는 문제', '필요한 화면과 기능', '희망 일정과 예산 기준'].map(
                    (label, index) => (
                      <li key={label}>
              ...
              >
                ...
                <label
                  className={cx(formStyles.formControl, formStyles.full)}
                  data-contact-group
                  data-contact-motion-group
                >
                  ...
                  <textarea
                    ...
                    name='message'
                    placeholder='현재 상황, 필요한 기능, 참고 서비스, 일정, 예산 범위, 걱정되는 부분을 자유롭게 적어주세요.'
                    minLength={20}
                    maxLength={3000}
                  ...
                  {errors.message ? (
                    ...
                    <span className={formStyles.help} data-contact-help>
                      정확하지 않아도 괜찮습니다. 내용을 확인한 뒤 필요한 사항을 다시 여쭙겠습니다.
                    </span>
                  )}
                </label>
                ...
                <div className={styles.consentBlock} data-contact-group>
                ...
                <div className={styles.formActions} data-contact-motion-group>
                  {result?.ok ? (
